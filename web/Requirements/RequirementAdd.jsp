                                                    ...
                                                    <span cellspacing="30">
                                                        ...
                                                        <div>
                                                            ...
                                                            <div class="col-sm-3 required" id=""> 
                                                                ...
                                                                <s:select id="reqCategoryValue" name="reqCategoryValue" cssClass="SelectBoxStyles form-control"  theme="simple" list="%{reqCategory}" value="%{requirementVTO.reqCatgory}" onchange="addRequirementSkillChange();"/>
                                                            </div>
                                                            <div class="col-sm-3 required" id="">
