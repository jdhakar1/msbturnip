                                    ...
                                    <div class="col-lg-12 ">
                                        ...
                                        <s:form action="addConsultantDetails" id="consultantForm" theme="simple" method="POST" enctype="multipart/form-data" >
                                            ...
                                            <div class="col-sm-4 required">
                                                ...
                                                <s:select cssClass="form-control SelectBoxStyles" name="primarySkillValue"  tabindex="30" headerKey="-1" headerValue="Select Primary Skill" id="primarySkillValue" list="reqCategory" value="%{requirementVTO.reqCategory}" onchange="AddConsultantSkillChange();"/> 
                                            </div>
                                        ...
                                        <div class="panel-body" id="task-panel"> 
                                            <div style="margin-left: -13%;">
                                                ...
                                                <div class="col-sm-4 " >
                                                    ...
                                                    <s:select cssClass="form-control SelectBoxStyles" name="consult_pcountry" id="consult_pcountry" headerKey="-1" headerValue="Select Country" list="consult_WCountry" onchange="" tabindex="36" />
                                                ...
                                                <div class="col-sm-4  " > 
                                                    ...
                                                    <s:select cssClass="form-control SelectBoxStyles"  name="consult_preferredRegion " id="consult_preferredRegion"  headerKey="-1" headerValue="Select preferred region" list="regionName" onchange="AddConsultantStateChange()" tabindex="5"/>
